...
- [NeRF: Neural Radiance Field in 3D Vision, A
  Comprehensive Review](https://arxiv.org/pdf/2210.00379.pdf) ARxiv 2022
...
- ** [Plenoxels](https://alexyu.net/plenoxels/?s=09), CVPR 2022
- ** [InstantNGP]()
...
- [Ha-NeRF😆: Hallucinated Neural Radiance Fields in the Wild](https://rover-xingyu.github.io/Ha-NeRF/), Chen et al., Arxiv 2021 | [github](https://github.com/rover-xingyu/Ha-NeRF) | [bibtex](./citations/Ha-NeRF.txt) `<!---chen2021hallucinated-->`
